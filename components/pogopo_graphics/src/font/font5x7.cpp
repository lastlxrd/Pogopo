...
static uint8_t glyph_column_5x7(char c, int column) {
    struct Glyph {
        char character;
        uint8_t data[5];
    };

    // Complete printable ASCII coverage keeps filenames and future game UI
    // from falling back to the box glyph for ordinary punctuation.
    static const Glyph glyphs[] = {
        ...
        {'^', {0x04,0x02,0x01,0x02,0x04}}, {'_', {0x40,0x40,0x40,0x40,0x40}}, {'`', {0x00,0x01,0x02,0x04,0x00}},
...
const Font& font5x7() {
    static const Font font = {5, 7, 1, &glyph_column_5x7};
    return font;
}
