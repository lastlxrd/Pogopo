...
// pogopoOS allocates this 64 KiB lookup table with the rest of the emulator
// state only while a GBA game is active. Keeping it as a pointer avoids a
// permanent internal-RAM penalty for the stable Game Boy and native apps.
...
extern u32 gamepak_buffer_limit;
extern u32 gamepak_file_size;
